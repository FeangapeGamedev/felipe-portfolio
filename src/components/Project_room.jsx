...
export const Project_room = ({ width = 15, depth = 15, height = 5 }) => {
  ...
  try {
    colorMap = useLoader(THREE.TextureLoader, "/src/assets/models/plaster/textures/blue_plaster_weathered_diff_4k.jpg");
    normalMap = useLoader(THREE.TextureLoader, "/src/assets/models/plaster/textures/blue_plaster_weathered_nor_gl_4k.jpg");
    roughnessMap = useLoader(THREE.TextureLoader, "/src/assets/models/plaster/textures/blue_plaster_weathered_arm_4k.jpg");
